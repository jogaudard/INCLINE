...
Ran mixed effect models with seed per capsule explained by size, site or number of capsules produced by the mother. Starting with using site and individual ID as random effects. Using a backward selection to remove variables in the model until We end up with a null model = seeds per capsules does not depend on size, site or number of capsules in the mother.
