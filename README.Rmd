...
For details on the clean dataset and the code to clean and extract these data from the raw data, see Table 2. The raw data is 554 provided on the FunCaB OSF23, the code to download and clean the data can be 555 found in the FunCaB GitHub repository24 in the file R/biomass/read_biomass.R. The 556 final cleaned data together with a data dictionary is provided on the FunCaB OSF23, 557 and the code to download the final cleaned data can be found in the FunCaB GitHub 558 repository24 in the file R/data_dic/download_clean_data.R.
