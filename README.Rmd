...
Dataset iii contains two dataset with demographic data S. procumbens and V. alpina.
...
The seedlings that survived all the way to the end of the two field seasons were harvested in September 2021, that was `r n_sampled_seedlings_SP` individuals of S. procumbens, and `r n_sampled_seedlings_VA` for V. alpina.
...
This dataset consists of the germination and survival of seedlings of the sub-alpine species in the INCLINE experiment.
...
The data set with measurements of flower production of the flowering alpine plant community was combined with two separate data sets with measurements of number of buds, flowers and capsules for S. procumbens and V. alpina, respectively.
...
This dataset consists of four separate datasets of i) soil moisture, ii) soil temperature at 6 cm below ground level, iii) temperature in the vegetation at ground level, and iv) air temperature 15 cm above the ground level recorded every 15 minutes by Tomst-loggers (Wild et al. 2019).
