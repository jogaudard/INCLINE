...
Table 6: Data dictionaries for the INCLINE demographic dataset for S. procumbens (dataset iii). 
```{r, echo=FALSE}
knitr::kable(demography_Sib_pro_dic)
```
Table 7: Data dictionaries for the INCLINE demographic dataset for V. alpina (dataset iii). 
```{r, echo=FALSE}
