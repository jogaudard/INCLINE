...
The seedlings that survived all the way to the end of the two field season were harvested in September 2021, that was `r n_sampled_seedlings_SP` individuals of S. procumbens, and `r n_sampled_seedlings_VA` for V. alpina.
